...
procedure TDlg_Cidades.FDQuery_PesquisaAfterOpen(DataSet: TDataSet);
begin
  (FDQuery_Pesquisa.fieldbyname('CODIGO') As TIntegerfield).displayformat := '000000';
end;

procedure TDlg_Cidades.FormCreate(Sender: TObject);
begin
  ...
  FDQuery_Pesquisa.SQL.Add('WHERE (A.CODESTADO = B.CODIGO) ORDER BY A.NOME');
